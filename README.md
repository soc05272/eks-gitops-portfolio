...
시작은 운영이었습니다. 오투에서 NHN·Naver Cloud의 AI 학습 환경을 맡아, 손으로 맞추던 환경을 Docker
이미지로 표준화해 제공 시간을 40% 줄이고 5TB 넘는 데이터를 Naver Cloud에서 NHN Cloud로 무중단 이관했습니다.
브레인즈컴퍼니로 옮긴 뒤에는 공공·금융 25곳 남짓 고객사에 통합관제 솔루션 ZENIUS를 구축·기술지원하며
온프레미스부터 KT Cloud까지 한 화면에서 관제하고, 장애 원인을 로그와 패킷으로 좁혔습니다. 운영은 몸에
뱄지만, 인프라가 왜 그렇게 설계됐는지는 늘 남의 답이었습니다.

AWS SA Professional을 취득한 뒤에도 제 계정에는 직접 만든 VPC가 없었습니다. 처음부터 끝까지 제
책임으로 세워 보는 수밖에 없었습니다. 5주 동안 장애 7건을 기록하고 선택마다 근거를 ADR로 남겼으며,
같은 환경을 다섯 번 부수고 다시 세웠습니다. 관제 화면 너머로 짐작만 하던 것들이 이제 제 손으로 만든
인프라 안에 있습니다.
